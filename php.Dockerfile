...
RUN yum install -y https://rpms.remirepo.net/enterprise/remi-release-9.rpm; \
    ...
    yum install -y php81 php81-php-bcmath php81-php-cli php81-php-common php81-php-fpm php81-php-gd php81-php-intl php81-php-json php81-php-mbstring php81-php-mysqlnd php81-php-pdo php81-php-pgsql php81-php-pecl-geoip php81-php-pecl-imagick php81-php-pecl-zip php81-php-xml php81-runtime php81-php-process; \
