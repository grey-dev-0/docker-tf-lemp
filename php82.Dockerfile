...
RUN yum install -y https://rpms.remirepo.net/enterprise/remi-release-9.rpm; \
    ...
    yum install -y php82 php82-php-bcmath php82-php-cli php82-php-common php82-php-fpm php82-php-gd php82-php-intl php82-php-json php82-php-mbstring php82-php-mysqlnd php82-php-pdo php82-php-pecl-geoip php82-php-pecl-imagick php82-php-pecl-zip php82-php-xml php82-runtime php82-php-process; \
