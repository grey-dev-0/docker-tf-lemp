...
RUN yum install -y https://rpms.remirepo.net/enterprise/remi-release-9.rpm; \
    ...
    yum install -y php84 php84-php-bcmath php84-php-cli php84-php-common php84-php-fpm php84-php-gd php84-php-intl php84-php-json php84-php-mbstring php84-php-mysqlnd php84-php-pdo php84-php-pgsql php84-php-pecl-geoip php84-php-pecl-imagick php84-php-pecl-zip php84-php-xml php84-runtime php84-php-process; \
